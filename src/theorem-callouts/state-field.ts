...
export const createTheoremCalloutsField = (plugin: CrossLinksPlugin) => StateField.define<RangeSet<TheoremCalloutInfo>>({
...
function getTheoremCalloutInfos(plugin: CrossLinksPlugin, state: EditorState, doc: Text, from: number, init: number): Range<TheoremCalloutInfo>[] {
